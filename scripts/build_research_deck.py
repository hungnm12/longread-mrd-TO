...
Numbers are read from ``data/manifests/week-001-candidate-landscape.json`` rather
...
Usage::
    ...
    python3 scripts/build_research_deck.py [-o output.pptx]
"""
...
MANIFEST = REPO / "data" / "manifests" / "week-001-candidate-landscape.json"
REFERENCES_TS = REPO / "site" / "src" / "data" / "references.ts"
DEFAULT_OUT = REPO / "outputs" / "accepted" / "mrd-research-report.pptx"
