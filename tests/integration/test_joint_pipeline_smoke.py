...
EXTRACT = os.path.join(REPO_ROOT, "scripts", "workflow", "joint_molecule", "extract_joint_molecules.py")
FUNNEL = os.path.join(REPO_ROOT, "scripts", "workflow", "feasibility_funnel", "report_funnel.py")
