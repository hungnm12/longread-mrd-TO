"""Leakage rules — the tests ``research/experiments/evaluation-plan.md`` §3 requires.
...
class Rule4LabelFirewallTest(unittest.TestCase):
    ...
    def test_explicit_check_rejects_a_smuggled_field(self):
        ...
        self.assertIn("claim-boundaries", str(ctx.exception))
...
class AblationGridIntegrityTest(unittest.TestCase):
    """The grid must match the table in research/experiments/evaluation-plan.md exactly."""
