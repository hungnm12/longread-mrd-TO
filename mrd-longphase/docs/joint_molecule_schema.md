...
[`../../docs/research/00_scope.md`](../../docs/research/00_scope.md) is the *informative
...
- **`methylation_probabilities_5hmc`** — the brief lists a single
  ...
  [`../../docs/research/05_claim_boundaries.md`](../../docs/research/05_claim_boundaries.md)
...
[`../../docs/research/04_evaluation_plan.md`](../../docs/research/04_evaluation_plan.md)
