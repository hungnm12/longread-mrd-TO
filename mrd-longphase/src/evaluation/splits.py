...
Supported levels (``docs/research/04_evaluation_plan.md`` §3):
...
def make_split(
    ...
    seeded draw is not (``docs/research/decision_log.md`` records which chromosomes).
...
def selection_provenance(
    ...
    (``docs/research/04_evaluation_plan.md`` §3 rule 3).
    """
