"""Metrics, in the priority order fixed by ``docs/research/04_evaluation_plan.md`` §2.
    ...
    def as_dict(self) -> Dict[str, object]:
        return {
            ...
            "note": (
                ...
                "(docs/research/04_evaluation_plan.md §2.7)."
            ),
        }
...
def bootstrap_by_group(
    ...
    (``docs/research/04_evaluation_plan.md`` §5).
    """
