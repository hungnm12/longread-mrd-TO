...
(`mrd-longphase/config/experiments/*.yaml`, key `thresholds:`). Thresholds must be written
...
[`05_claim_boundaries.md`](./05_claim_boundaries.md).
...
- The six ablation models A–F defined in [`04_evaluation_plan.md`](./04_evaluation_plan.md).
...
[`05_claim_boundaries.md`](./05_claim_boundaries.md). Then, and only then, consider
...
```yaml
# mrd-longphase/config/experiments/<experiment>.yaml
thresholds:
