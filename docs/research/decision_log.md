...
Related: [`../DECISIONS.md`](../DECISIONS.md) holds engineering/architecture decisions from
...
|---|---|---|
| Repository layout: reuse `mrd-longphase/` vs. flatten to the brief's tree | Phases 3–8 file locations | see [`../migration_plan.md`](../migration_plan.md) §4 |
...
| Literature search to promote the candidate gap | citing the gap as established | [`02_research_gap.md`](./02_research_gap.md) §"Next action" |
