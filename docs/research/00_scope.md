...
Date: 2026-08-16
Supersedes the Week 1 framing in [`../RESEARCH_SCOPE.md`](../RESEARCH_SCOPE.md) as the
...
record is defined in [`../../mrd-longphase/docs/joint_molecule_schema.md`](../../mrd-longphase/docs/joint_molecule_schema.md)
once Phase 3 lands.
