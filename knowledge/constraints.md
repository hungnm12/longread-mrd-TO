...
| **Absolute server paths stay out of the public site.** Full paths belong in `docs/`, `knowledge/` and manifests | `.agent-context/AGENTS.md`; the site validator rejects absolute paths in evidence records `[repo]` |
