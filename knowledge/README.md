...
| File | Answers |
|---|---|
| [`mrd-method-synthesis.md`](./mrd-method-synthesis.md) | What the supplied methods do, and what the field's recurring move is |
...
- `docs/research/` holds the **research contract** — scope, hypotheses, evaluation plan,
