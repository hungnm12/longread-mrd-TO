...
**Research-direction** decisions live in [`research/decision_log.md`](./decision-log.md).
...
- Reason: `src/` already contained empty `evidence/`, `models/` and
  ...
  smoke test, two READMEs, `RESEARCH_SCOPE.md` and `data/manifests/*.json`, to satisfy
  a diagram.
...
- Full analysis: [`migration_plan.md`](../../archive/migration_plan.md).
...
- Revisit trigger: a single dilution level exceeding ~10 GB of records, or Phase 5 model
  ...
  module.
- Full analysis: [`../orchestration/schemas/joint-molecule.schema.md`](../../orchestration/schemas/joint-molecule.schema.md) §3.
