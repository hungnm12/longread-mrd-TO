...
> **This corrects the research contract.** `research/knowledge/scope.md` records "~25×, **1
> replicate**" per level, and `research/knowledge/methods/paper-patterns.md` argues that "one replicate
...
| `mrd/data/manifests/week-001-candidate-landscape.json` | small `[repo]` | The summary the site and the deck read |
